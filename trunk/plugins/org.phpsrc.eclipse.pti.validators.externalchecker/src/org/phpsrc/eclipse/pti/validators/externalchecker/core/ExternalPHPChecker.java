...
public class ExternalPHPChecker extends AbstractValidator {
	...
	private static final String DEBUG_PRINT_OUTPUT = "debug_print_output"; //$NON-NLS-1$
	...
	public ExternalPHPChecker(String id, String name, IValidatorType type) {
		super(id, name, type);
	...
	protected void load(Element element) {
		...
		this.printOutput = "1".equals(element.getAttribute(DEBUG_PRINT_OUTPUT));
	...
	public void storeTo(Document doc, Element element) {
		...
		element.setAttribute(DEBUG_PRINT_OUTPUT, this.printOutput ? "1" : "0"); //$NON-NLS-1$
	...
	protected Object clone() {
		try {
			final ExternalPHPChecker clone = (ExternalPHPChecker) super.clone();
