...
* @version    CVS: $Id: HTTPRequest.php 308636 2011-02-24 20:03:07Z sergiosgc $
    ...
    public function sendRequest()
    {
        ...
        if ($ch = curl_init()) {
            if (
                ...
                curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-type: text/xml; charset='.$this->_encoding, 'User-Agent: PEAR::XML_RPC2/1.0.7')) &&
