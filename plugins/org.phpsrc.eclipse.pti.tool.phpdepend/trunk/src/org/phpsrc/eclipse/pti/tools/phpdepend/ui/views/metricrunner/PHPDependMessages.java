...
public final class PHPDependMessages extends NLS {

	private static final String BUNDLE_NAME = "org.phpsrc.eclipse.pti.tools.phpdepend.ui.views.metricrunner.PHPDependMessages";//$NON-NLS-1$
	...
	static {
		NLS.initializeMessages(BUNDLE_NAME, PHPDependMessages.class);
	}

	private PHPDependMessages() {
		// Do not instantiate
	}
