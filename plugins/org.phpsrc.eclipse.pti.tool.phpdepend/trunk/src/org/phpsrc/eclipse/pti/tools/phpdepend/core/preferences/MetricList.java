...
public class MetricList {
	public static Metric[] getAll() {
		return new Metric[] {
				...
				new Metric("rcr", "Reverse code rank", Metric.PROPERTY_CLASS
						| Metric.PROPERTY_PACKAGE),
				// Coupling (Project)
				new Metric("calls", "Number of called methods and functions",
						Metric.PROPERTY_PROJECT),
				new Metric("fanout", "Number of referenced types", Metric.PROPERTY_PROJECT),
				// Cyclomatic Complexity (Project, Method, Function)
				new Metric("ccn", "Cyclomatic Complexity", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_METHOD | Metric.PROPERTY_FUNCTION),
				new Metric("ccn2", "Extended Cyclomatic Complexity", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_METHOD | Metric.PROPERTY_FUNCTION),
				// Dependency (Package)
				...
				new Metric("roots", "Number of root classes within the analyzed system",
						Metric.PROPERTY_PROJECT),
				...
				new Metric("nop", "Number Of Packages", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_PACKAGE | Metric.PROPERTY_CLASS
						| Metric.PROPERTY_INTERFACE),
				new Metric("noc", "Number Of Classes", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_PACKAGE | Metric.PROPERTY_CLASS
						| Metric.PROPERTY_INTERFACE),
				new Metric("noi", "Number Of Interfaces", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_PACKAGE | Metric.PROPERTY_CLASS
						| Metric.PROPERTY_INTERFACE),
				new Metric("nom", "Number Of Methods", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_PACKAGE | Metric.PROPERTY_CLASS
						| Metric.PROPERTY_INTERFACE),
				new Metric("nof", "Number Of Functions", Metric.PROPERTY_PROJECT
						| Metric.PROPERTY_PACKAGE | Metric.PROPERTY_CLASS
						| Metric.PROPERTY_INTERFACE),
				...
				// Other
				new Metric("dit", "Depth of inheritence tree"),
				new Metric("eloc", "Executable lines of code"),
				new Metric("nom", "Number of methods"), new Metric("npath", "NPath Complexity"),
				new Metric("noam", "Number of added methods"),
				new Metric("nocc", "Number of child classes"),
