...
public abstract class OpenEditorAction extends Action {
	...
	protected MetricRunnerViewPart fTestRunner;
	private final boolean fActivate;

	protected OpenEditorAction(MetricRunnerViewPart testRunner, String filePath) {
		this(testRunner, filePath, true);
	}

	public OpenEditorAction(MetricRunnerViewPart testRunner, String filePath, boolean activate) {
		this(testRunner, PHPDependPlugin.resolveProjectFile(filePath), activate);
	}

	public OpenEditorAction(MetricRunnerViewPart testRunner, IFile file, boolean activate) {
		super(PHPDependMessages.OpenEditorAction_action_label);
