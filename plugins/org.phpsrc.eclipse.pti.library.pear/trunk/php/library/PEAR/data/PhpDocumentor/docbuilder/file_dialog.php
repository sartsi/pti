...
if ('/srv/pti/pear/svn/data' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( '/srv/pti/pear/svn/data' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('/srv/pti/pear/svn/data' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = '/srv/pti/pear/svn/data' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
