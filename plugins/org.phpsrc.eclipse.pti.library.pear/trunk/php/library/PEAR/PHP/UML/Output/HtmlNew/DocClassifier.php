 ...
 * @license    http://www.gnu.org/licenses/lgpl.html LGPL License 3
 */
abstract class PHP_UML_Output_HtmlNew_DocClassifier extends PHP_UML_Output_HtmlNew_Documentor
{
    /**
    ...
    private function getDescriptionBlock(PHP_UML_Metamodel_Classifier $p)
    {
        ...
        if ($nbAllInherited>0) {
            ...
            $sum  = -15;
            $img  = '<img src="'.$this->ctx->rpt.self::RESOURCES_DIRNAME.'/inherit.gif" alt="extended by "/>';
