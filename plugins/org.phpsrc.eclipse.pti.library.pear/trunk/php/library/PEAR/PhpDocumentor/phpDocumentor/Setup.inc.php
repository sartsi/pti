...
class phpDocumentor_setup
{
    ...
    function readConfigFile($file)
    {
        ...
        {
            if ('/srv/pti/pear/svn/data' != '@'.'DATA-DIR@')
            {
                $configdir = str_replace('\\','/', '/srv/pti/pear/svn/data/PhpDocumentor') . PATH_DELIMITER . 'user' . PATH_DELIMITER;
            } else {
    ...
    function parseIni()
    {
        ...
        if ('/srv/pti/pear/svn/data' != '@'.'DATA-DIR@')
        {
            $options = phpDocumentor_parse_ini_file(str_replace('\\','/', '/srv/pti/pear/svn/data/PhpDocumentor') . PATH_DELIMITER . 'phpDocumentor.ini',true);
            phpDocumentor_out("   (found in " . '/srv/pti/pear/svn/data/PhpDocumentor' . PATH_DELIMITER . ")...\n");
        } else {
